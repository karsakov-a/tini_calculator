...
## Описание проекта
CITI Calculator — это автономное настольное приложение для врачей и клиницистов, предназначенное для быстрого расчёта тромбо-воспалительного индекса (CITI) — прогностического показателя, оценивающего риск неблагоприятного исхода у пациентов с тяжёлыми инфекционными и воспалительными состояниями.
